...
export function useCreateCharge(): MutationTuple<
  ICreateChargeResponse,
  ICreateChargeVariables
> {
  return useMutation<ICreateChargeResponse, ICreateChargeVariables>(
...
export function usePixInfosByTxid(
  txid: string
): QueryResult<IPixInfosResponse, IPixInfosVariables> {
