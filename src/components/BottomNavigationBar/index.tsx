...
export function BottomNavigationBar(props: BottomNavigationType) {
  ...
  if (props.playerScreen) {
    viewContent = (
      <View
        className={`h-24 bg-${
          props.isDisabled ? "[#292929]" : "transparent"
        } w-full flex flex-row items-center justify-center gap-y-[5px]`}
      >
        {showButtons && (
          <Animated.View
          ...
          >
            ...
            >
              <Image source={require("../../assets/settings_black_icon.png")} />
            </TouchableOpacity>
            <TouchableOpacity
              className="flex flex-row items-center justify-center w-[45px] h-[45px] rounded-full overflow-hidden bg-slate-100"
              onPress={() =>
            ...
            >
              <Image source={require("../../assets/black_heart.png")} />
            </TouchableOpacity>
          </Animated.View>
        )}
        ...
        {showButtons && (
          ...
          >
            <TouchableOpacity className="flex flex-row items-center justify-center w-[45px] h-[45px] rounded-full overflow-hidden bg-slate-100">
              <Image source={require("../../assets/house_black_icon.png")} />
            </TouchableOpacity>
            <TouchableOpacity
              className="flex flex-row items-center justify-center w-[45px] h-[45px] rounded-full overflow-hidden bg-slate-100"
              onPress={() => navigation.navigate("InfoReserva")}
            >
              <Image source={require("../../assets/calendar_black_icon.png")} />
            </TouchableOpacity>
          </Animated.View>
        )}
      </View>
    ...
    viewContent = (
      <View
        className={`fixed h-24 ${
          props.isDisabled ? "bg-transparent" : "bg-transparent"
        } w-full flex flex-row items-center justify-center gap-y-[5px]`}
      >
        {showButtons && (
          <Animated.View
          ...
          >
            ...
            >
              <Image source={require("../../assets/money_safe_icon.png")} />
            </TouchableOpacity>
          </Animated.View>
        )}
