...
export default function FavoriteCourts() {
	...
	console.log(data?.usersPermissionsUser?.data.attributes?.favorite_courts?.data[0]?.attributes?.court_type?.data?.attributes?.courts?.data[0]?.attributes?.court_availabilities)
	...
	// 					width: 138}} key={5}>
	// 							<InfosCourt.Content lastScheduling={data?.usersPermissionsUser?.data.attributes?.favorite_courts?.data[0]?.attributes?.court_type?.data?.attributes?.courts?.data[0]?.attributes?.court_availabilities?.data[0]?.attributes?.schedulings?.data[0]?.attributes?.date}>
