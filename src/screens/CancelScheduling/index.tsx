...
export default function CancelScheduling({
  ...
  useEffect(() => {
    ...
    if (
      route.params.establishmentPicture !== undefined &&
      route.params.establishmentPicture !== null &&
      route.params.establishmentPicture !== ""
    ) {
  ...
  const handleTextChange = (text: string) =>
    text.length <= maxLength && setCancelReason(text);
  ...
  useEffect(() => {
    ...
    if (
      ...
      data.scheduling.data.attributes.court_availability.data.attributes.court
        .data &&
      data.scheduling.data.attributes.court_availability.data.attributes.court
        .data.attributes.court_types.data
    ) {
      newCourtType =
    ...
    <View className="h-full w-full pl-[30px] pr-[30px] pt-[20px]">
      {loading ? (
        ...
        <View className="flex justify-between h-full">
          <View>
            <Text className="font-black text-[16px] text-[#292929]">
              Cancelamento de reserva
            </Text>
            <Text className="text-[14px] text-[#292929] opacity-50 underline mt-[20px]">
              Informações gerais:
            </Text>
            ...
            data.scheduling.data.attributes.court_availability.data.attributes
              ...
              <CancelSchedulingInfo
                userName={
                  data.scheduling.data.attributes.owner.data.attributes.name
                }
                courtName={courtName}
                courtType={courtType}
                startsAt={
            ...
            <Text className="text-[12px] text-[#292929] mt-[5px]">
            ...
            <View className="h-[150px] rounded-[5px] border border-[#949494] flex flex-col justify-between pl-[8px] pr-[8px] pt-[5px] pb-[5px] mt-[10px]">
              ...
              <View className="items-end justify-center">
                <Text className="text-[12px] text-[#292929] opacity-50">
                  {cancelReason.length}/{maxLength}
                </Text>
              </View>
            </View>

            <Text className="text-[12px] text-[#292929] mt-[5px] text-start">
              Ao confirmar o cancelamento, o extorno financeiro será realizado
          ...
          <View>
            <TouchableOpacity
              ...
              className="w-full h-14 bg-[#FF6112] items-center justify-center rounded-[5px]"
            >
            ...
            <View className="h-full w-full justify-center items-center">
              <View className="h-[256px] w-[350px] bg-white rounded-[5px] items-center justify-center">
                <View className="w-full h-[60%] items-center justify-between">
                  <Text className="text-center font-bold text-[16px] w-[60%]">
                  ...
                  <View className="flex flex-row items-center">
                    ...
                    >
                      <Text className="w-full h-full font-medium text-[14px] text-[#8D8D8D]">
                        Cancelar
                      </Text>
                    </Button>
                    ...
                    >
                      <Text className="w-full h-full font-medium text-[14px] text-white">
          ...
          <Modal
            visible={showSuccessCancel}
            animationType="fade"
            transparent={true}
            onRequestClose={closeSuccessCancelModal}
          >
            <View className="h-full w-full justify-center items-center">
              <View className="h-[256px] w-[350px] bg-white rounded-[5px] items-center justify-center">
                <View className=" items-center justify-evenly h-[80%] w-full">
                  <Text className="text-center font-bold text-[16px] w-[50%]">
