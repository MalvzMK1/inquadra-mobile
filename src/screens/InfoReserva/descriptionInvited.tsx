      ...
      <View className="flex w-max h-96 bg-zinc-900  px-5">
        <View className="flex-row items-start justify-start w-max h-max pt-2">
          <View>
            <Image
              source={{
                uri: "https://static.sportit.com.br/public/sportit/imagens/produtos/quadra-poliesportiva-piso-modular-externo-m2-2921.jpg",
              }}
          ...
          <View className="flex item-start h-24 w-max">
            <View className="flex justify-start items-start h-max w-max pl-1">
              ...
              <View className="pt-2">
                <Text className="font-black text-xs text-red-500">
                  CANCELAR
                </Text>
              </View>
            </View>
        ...
        <View className=" h-18 w-full flex items-center">
          <View className="w-60 pt-2 item-center">
            <Text className="font-black text-xs text-center text-white">
              Tempo restante para pagamento 4 dias, 3 horas e 20 minutos
            </Text>
          </View>
        </View>
      ...
      <View className="h-screen w-full  px-5 items-center justify-start pt-4">
        ...
        <View className="pt-3">
          <Text className="text-gray-50 font-semibold text-center">
            Compartilhe essa página ! Informações serão mostradas aqui uma vez
            que outros realisem pagamentos{" "}
          </Text>
        </View>
      </View>
    </View>
