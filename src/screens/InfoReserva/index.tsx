                ...
                }
                {
                    !user_id && (
                        <View className="w-full h-fit flex items-center justify-center mt-[8px]">
                            <Text className="text-[18px] text-center text-white">FAÇA <Text onPress={() => navigation.navigate("Login")} className="text-[18px] text-white flex items-center justify-center underline">LOGIN</Text> NO APP PARA PODER VISUALIZAR E/OU EFETUAR UMA RESERVA!</Text>
                        </View>
                    )
                }
            </ScrollView>
