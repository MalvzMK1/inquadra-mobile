...
const carouselItemsTest = [
    ...
    {
        imgUrl:
            require('../../assets/football_field.jpg')
    },
    {
        imgUrl:
            require('../../assets/quadra.png')
...
const carouselCardItem = ({ item }: {
    ...
    return (
        <View className="w-full justify-center items-center">
            <Image className="h-20 w-40 bg-slate-500" source={item.imgUrl}></Image>
        </View>
    )
}

export default function EstablishmentInfo({route}: {route: {params: {establishmentInfo: any}}}) {

    console.log(
        route.params?.establishmentInfo
    );
