					...
					<View className="pt-5 px-9">
						<TouchableOpacity onPress={handleCardClick}>
							<View className="h-30 border border-gray-500 rounded-md">
								<View
									className="w-full h-14 border border-gray-500 rounded-md flex flex-row justify-between items-center px-4">
									<FontAwesome
							...
							(cards.length > 0 ? (
								...
								<View className="border border-gray-500 rounded-xl p-4 mt-3 space-y-2">
									...
									<View>
										...
										<View
											className="flex flex-row items-center justify-between p-3 border border-neutral-400 rounded bg-white">
											<SelectList
